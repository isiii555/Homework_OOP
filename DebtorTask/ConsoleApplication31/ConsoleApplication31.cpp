...
#pragma region Fields
	...
	Debtor* debtors = new Debtor[DebtorCount]{
		{"islam","salamzade","Akhmedli","0707260043",true,"Shaki",300},
		{"samil","nabizade","AynaSultanova","0707260043",false,"Naftalan",1200},
		{"namiq","rasullu","Kubinka","0707260043",true,"Ismayilli",500}
	};
#pragma endregion
...
int main() {
	Bank kapital;
	kapital.ShowAllDebtors();
	kapital.Show1000Debtor();
	kapital.ShowLateDebtors();
}
